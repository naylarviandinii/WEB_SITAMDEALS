            ...
            <div class="glass-panel rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-colors">
                <div class="flex items-center gap-4 sm:gap-5 flex-1">
                    <input type="checkbox" name="selected_items[]" value="{{ $item->id }}"
                        ...
                        class="cart-checkbox">
                    <img src="/images/{{ $item->product->image }}" class="w-16 h-16 sm:w-20 sm:h-20 object-cover rounded-xl border border-black/5" onerror="this.src='https://via.placeholder.com/80'">
